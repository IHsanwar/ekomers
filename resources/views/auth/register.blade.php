<x-guest-layout>
    <div class="text-center mb-6">
        ...
        <p class="text-slate-500 mt-1">Get started with your free account</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-6 text-center">
            ...
            <a href="{{ route('login') }}" class="text-sm text-primary-600 hover:text-primary-700 font-medium ml-1">
                Sign in
            </a>
        </div>
    </form>
