...
<div class="flex items-center gap-4 mb-6">
    ...
    <div>
        ...
        <p class="text-sm text-slate-500 mt-1">Update product information</p>
    </div>
</div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach($product->images as $img)
                                        <img src="{{ asset($img->image_url) }}" alt="Gallery image" class="w-20 h-20 object-cover rounded-lg border border-slate-200">
                                    @endforeach
                                </div>
                            </div>
                        @endif
